...
pacman::p_load(npmv, MANOVA.RM, tidyverse, MASS, pbmcapply, rankFD)
...
simulate_data <- function(N, t_size, p_size, scenario, treat_resp, placeb_resp, mean_shift, sd_shift) {
  ...
  rho <- 0.7   # gewünschte Korrelation
  sd_pain <- 3
  sd_itch <- 3
...
write.table(df_summary, file = "simulation_results_servEB0.7.txt",
